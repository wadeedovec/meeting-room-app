...
var require_msal_browser = __commonJS({
  "node_modules/@azure/msal-browser/lib/msal-browser.cjs"(exports) {
    ...
    var AuthErrorCodes = Object.freeze({
      __proto__: null,
    ...
    var ClientAuthErrorCodes = Object.freeze({
      __proto__: null,
      authTimeNotFound,
    ...
    var ClientConfigurationErrorCodes = Object.freeze({
      __proto__: null,
      authorityMismatch,
...
Error Description: ${typedError.message}`);
    ...
    var InteractionRequiredAuthErrorCodes = Object.freeze({
      __proto__: null,
      badToken,
      consentRequired,
      interactionRequired,
...
${serverError}`);
    ...
    var BrowserAuthErrorCodes = Object.freeze({
      __proto__: null,
    ...
    var BrowserConfigurationAuthErrorCodes = Object.freeze({
      __proto__: null,
    ...
    var NestedAppAuthAdapter = class {
      ...
      fromNaaAccountInfo(fromAccount, idToken, idTokenClaims) {
        ...
        const name2 = fromAccount.name || (effectiveIdTokenClaims == null ? void 0 : effectiveIdTokenClaims.name);
    ...
    var BrowserPerformanceClient = class extends PerformanceClient {
      ...
      deleteIncompleteSubMeasurements(inProgressEvent) {
        var _a;
        void ((_a = getPerfMeasurementModule()) == null ? void 0 : _a.then((module2) => {
      ...
      startMeasurement(measureName, correlationId) {
        ...
        const browserMeasurement = (_a = getPerfMeasurementModule()) == null ? void 0 : _a.then((module2) => {
    ...
    var BrowserPerformanceMeasurement$1 = Object.freeze({
      __proto__: null,
...
var require_AuthCodeMSALBrowserAuthenticationProvider = __commonJS({
  "node_modules/@microsoft/microsoft-graph-client/lib/src/authentication/msal-browser/AuthCodeMSALBrowserAuthenticationProvider.js"(exports) {
    ...
    var tslib_1 = (init_tslib_es6(), __toCommonJS(tslib_es6_exports));
    var msal_browser_1 = require_msal_browser();
          ...
          return tslib_1.__awaiter(this, void 0, void 0, function() {
            ...
            return tslib_1.__generator(this, function(_a) {
              switch (_a.label) {
                ...
                case 3:
                  error_1 = _a.sent();
                  if (!(error_1 instanceof msal_browser_1.InteractionRequiredAuthError)) return [3, 7];
                  if (!(this.options.interactionType === msal_browser_1.InteractionType.Redirect)) return [3, 4];
                  this.publicClientApplication.acquireTokenRedirect({ scopes });
                  return [3, 6];
                case 4:
                  if (!(this.options.interactionType === msal_browser_1.InteractionType.Popup)) return [3, 6];
